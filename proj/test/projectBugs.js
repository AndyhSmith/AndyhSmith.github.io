...
function updateGraphics() {
	...
	for (o in objects) {
		...
		// 544x 512y
		ctx.drawImage(img,width*objects[o].animationPosition,objects[o].objType,100,100,-50*objects[o].scale,-50*objects[o].scale,100 * objects[o].scale,100 * objects[o].scale);
		ctx.restore();	
	}
	// add bugs
